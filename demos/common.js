...
class line3
{
	...
	static draw(canv, view, l, len)
	{
		const seg = line_seg3.from_line(l, len);
		line_seg3.draw(canv, view, seg);
	}	
}
...
class line_seg3
{
	...
	static draw(canv, view, l)
	{
		const proj = line_seg2.project(l, view);
		line_seg2.draw(canv, proj);
	}	
}
